...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/japan8xinc)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/japan8xinc
```

A live public deployment of this template is available at [https://japan8xinc.templates.workers.dev](https://japan8xinc.templates.workers.dev)
